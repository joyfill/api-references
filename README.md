...
This repository hosts API reference documentation for three platforms, served via a single GitHub Pages site.

### Structure
- `kotlin/`: Kotlin/JVM reference (e.g., Dokka output)
- `ios/`: iOS (Swift) reference (e.g., DocC static site)
- `js/`: JavaScript reference (e.g., TypeDoc or similar)
...
1. Regenerate the platform docs with your usual tool (Dokka, DocC, TypeDoc, etc.).
2. Replace the contents of the corresponding directory: `kotlin/`, `ios/`, or `js/`.
...
- Links are relative; directory names must remain `kotlin/`, `ios/`, and `js/`.
